  ...
  //  private ImageView popcid, popcod;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // popcod = findViewById(R.id.popupCOD);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(classBooking.getWedding() != 0 || classBooking.getBirthday() != 0 || classBooking.getSpecial() != 0 ){
                    databaseReference.child("booking1").setValue(classBooking);
                    Toast.makeText(TableBooking.this, "Sent to database", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(TableBooking.this, ActivityCheckout.class));
                } else {
                    Toast.makeText(TableBooking.this, "Please choose table", Toast.LENGTH_SHORT).show();
                }
            }
        });
      ...
      //  btnCon.setOnClickListener(new View.OnClickListener() {
          //  @Override
           // public void onClick(View v) {
        //        startActivity(new Intent(TableBooking.this,ActivityReceipt.class));
       //     }
       // });
    }
